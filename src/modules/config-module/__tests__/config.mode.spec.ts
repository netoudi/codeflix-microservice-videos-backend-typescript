...
describe('Schema Unit Tests', () => {
  describe('DB Schema', () => {
    ...
    describe('DB_CONNECTION', () => {
      test('invalid cases', () => {
        expectValidate(schema, {}).toContain('"DB_CONNECTION" is required');
        expectValidate(schema, { DB_CONNECTION: 5 }).toContain('"DB_CONNECTION" must be one of [mysql, sqlite]');
      });

      test('valid cases', () => {
        const arrange = ['mysql', 'sqlite'];
        arrange.forEach((value) => {
          expectValidate(schema, { DB_CONNECTION: value }).not.toContain('DB_CONNECTION');
        });
      });
    });
    ...
    describe('DB_DATABASE', () => {
      test('invalid cases', () => {
        expectValidate(schema, { DB_CONNECTION: 'sqlite' }).not.toContain('"DB_DATABASE" is required');
        expectValidate(schema, { DB_CONNECTION: 'mysql' }).toContain('"DB_DATABASE" is required');
    ...
    describe('DB_USERNAME', () => {
      test('invalid cases', () => {
        expectValidate(schema, { DB_CONNECTION: 'sqlite' }).not.toContain('"DB_USERNAME" is required');
        expectValidate(schema, { DB_CONNECTION: 'mysql' }).toContain('"DB_USERNAME" is required');
      ...
      test('valid cases', () => {
        const arrange = [
          { DB_CONNECTION: 'sqlite' },
          { DB_CONNECTION: 'sqlite', DB_USERNAME: 'some value' },
          { DB_CONNECTION: 'mysql', DB_USERNAME: 'some value' },
        ];
    ...
    describe('DB_PASSWORD', () => {
      test('invalid cases', () => {
        expectValidate(schema, { DB_CONNECTION: 'sqlite' }).not.toContain('"DB_PASSWORD" is required');
        expectValidate(schema, { DB_CONNECTION: 'mysql' }).toContain('"DB_PASSWORD" is required');
    ...
    describe('DB_PORT', () => {
      test('invalid cases', () => {
        expectValidate(schema, { DB_CONNECTION: 'sqlite' }).not.toContain('"DB_PORT" is required');
        expectValidate(schema, { DB_CONNECTION: 'mysql' }).toContain('"DB_PORT" is required');
      ...
      test('valid cases', () => {
        const arrange = [
          { DB_CONNECTION: 'sqlite' },
          { DB_CONNECTION: 'sqlite', DB_PORT: 10 },
          { DB_CONNECTION: 'sqlite', DB_PORT: '10' },
          { DB_CONNECTION: 'mysql', DB_PORT: 10 },
          { DB_CONNECTION: 'mysql', DB_PORT: '10' },
        ];
        arrange.forEach((value) => {
...
describe('ConfigModule Unit Tests', () => {
  it('should throw an error when env vars are invalid', () => {
    try {
      ...
      expect(e.message).toContain('"DB_CONNECTION" must be one of [mysql, sqlite]');
    }
  });
