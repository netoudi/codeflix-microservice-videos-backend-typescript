...
export const down: MigrationFn<Sequelize> = async ({ context: sequelize }) => {
  await sequelize.getQueryInterface().removeConstraint('cast_member_video', 'cast_member_video_video_id');
  await sequelize.getQueryInterface().removeConstraint('cast_member_video', 'cast_member_video_cast_member_id');
