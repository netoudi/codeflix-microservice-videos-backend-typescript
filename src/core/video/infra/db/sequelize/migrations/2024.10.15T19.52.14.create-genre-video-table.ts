...
export const down: MigrationFn<Sequelize> = async ({ context: sequelize }) => {
  await sequelize.getQueryInterface().removeConstraint('genre_video', 'genre_video_video_id');
  await sequelize.getQueryInterface().removeConstraint('genre_video', 'genre_video_genre_id');
